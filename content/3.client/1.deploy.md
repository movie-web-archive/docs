...
1. Configure the environment variables:
   - `VITE_CORS_PROXY_URL`: Enter your proxy URL here. Make sure not to have a slash at the end of your URL.
   ...
   - `VITE_BACKEND_URL`: Only set if you have a self-hosted backend. Put in your backend URL. Check out [configuration reference](../4.client/2.configuration.md) for details. Make sure not to have a slash at the end of the URL.
1. Click "Deploy"
...
4. Put your proxy URL in-between the double quotes of `VITE_CORS_PROXY_URL: ""`. Make sure not to have a slash at the end of your URL.
...
6. If you have a self-hosted backend server, enter your URL in the `VITE_BACKEND_URL` variable. Check out [configuration reference](../4.client/2.configuration.md) for details. Make sure not to have a slash at the end of the URL.
6. Save the file.
